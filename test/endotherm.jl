...
bodyshape = Ellipsoid(mass, ρ_flesh, shape_b, shape_b) # define shape as a Cylinder struct of type 'Shape' and give it required values
...
endotherm(; model_pars, bodyshape, body_pars, integument_pars, insulation_pars, 
