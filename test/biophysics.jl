...
shapeb = 3
shapec = 2 / 3
#shape_body = Cylinder(mass, ρ_body, shapeb) # define shape_body as a Cylinder struct of type 'Shape' and give it required values
shape_body = Ellipsoid(mass, ρ_body, shapeb, shapec) # define shape_body as an Ellipsoid struct of type 'Shape' and give it required values
