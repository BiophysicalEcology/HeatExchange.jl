...
ρ_body = (ecto_input.rho_body)u"kg/m^3"
...
# metabolism
metab_out = metabolism(mass, T_core, M1, M2, M3, M4)
...
# respiration
resp_out = respiration(T_core, Q_metab, fO2_extract, pant, rq, T_air, rh, P_atmos, fO2, fCO2, fN2)
...
# convection
conv_out = convection(geometric_traits, A_convection, T_air, T_surface, wind_speed, P_atmos, fluid, fO2, fCO2, fN2)
...
#:QSOLAR, :QSDIFF, :QSRSB, :QSSKY, :QSOBJ
##:HC, :HD, :SH, :QFREE, :HCFREE, :HCFORC, :SHFREE, :SHFORC, :HDFREE, :HDFORC, :QSEVAP, :WEVAP, 
#:G_V
