...
function energy_balance(T_x)
    ...
    evap_out = evap(T_x, T_x, J_resp, ψ_org, p_wet, A_tot, conv_out.Hd, p_eyes, T_air, rh, elev, P_atmos)
...
energy_balance(b::Body, p::Model, o::OrganismalVars, e::EnvironmentalVars) = begin
    ...
    evap_out = evap(body_organism, model_params, org_vars, env_vars, J_resp, conv_out.Hd)
    Q_evap = evap_out.Q_evap # evaporative heat loss
